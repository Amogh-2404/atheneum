...
export default function ToggleBlock({ title, content }: ToggleBlockType) {
  return (
    <details className="my-4 rounded-lg border border-[var(--border)] open:pb-2">
      <summary className="cursor-pointer select-none px-4 py-3 font-semibold text-[var(--text-h)] hover:bg-[var(--code-bg)]">
        {renderText(title)}
      </summary>
